...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('monthly_budget', models.DecimalField(decimal_places=2, default=0, max_digits=12, verbose_name='Месячный бюджет')),
                ...
                ('ai_recommendations_enabled', models.BooleanField(default=True, verbose_name='AI рекомендации')),
